import { formatGherkinLines, formatGherkinString, removeMultipleSpaces } from './formatterHelpers';
...
describe('removeMultipleSpaces', () => {
  test('removeMultipleSpaces', () => {
    expect(removeMultipleSpaces("  toto titi    tutu   ")).toBe(" toto titi tutu ");
  });
});